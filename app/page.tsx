...
export default function Home() {
  return (
    <main className="bg-ink text-concrete">
      {/* Top bar */}
      <header className="sticky top-0 z-10 border-b border-concrete/10 bg-ink/90 backdrop-blur">
      ...
      {/* Section A: Hero */}
      <section className="blueprint-grid relative border-b border-concrete/10 bg-ink">
        ...
        <div className="border-t border-concrete/10">
      ...
      <section className="blueprint-grid-light bg-concrete text-ink">
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-6 py-20 md:grid-cols-2 md:py-28">
          <div className="crosshair order-2 border border-ink/20 p-2 md:order-1">
            <img
              src="/Oscar_1.jpg"
          ...
          <div className="order-1 md:order-2">
            ...
            <ul className="mt-8 space-y-3 font-mono text-sm text-ink/70">
              ...
              <li className="border-t border-ink/15 pt-3 border-b pb-3">
      ...
      <section className="border-b border-concrete/10 bg-steel text-concrete">
      ...
      <footer className="border-t border-concrete/10 bg-ink">
